...
public class ProfileMinePageController(HttpClient http, IConfiguration configuration) : Controller
{
    ...
    public async Task<IActionResult> Details()
    {
       ...
       // string userId = "aaaaaaaa-2dbf-4f6d-aa18-2fff495a9c1c";  // en  userId av UserProvider_Rika
        ...
        try
        {
            ...
            {
                viewModel = JsonConvert.DeserializeObject<ProfileUpdateViewModel>(await response.Content.ReadAsStringAsync());
